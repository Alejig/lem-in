...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/08 10:30:07 by aljigmon          #+#    #+#             */
/*   Updated: 2019/02/11 15:49:43 by aljigmon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char			*ft_strinfo(char const *s, char (*f)(char));
char			*ft_strinfoi(char const *s, char (*f)(unsigned int, char));
...
t_list			*ft_lstinfo(t_list *lst, t_list *(*f)(t_list *elem));
